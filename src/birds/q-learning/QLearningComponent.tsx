...
export const QLearningComponent = (props: QLearningComponentProps) => {
    ...
    return <>
        ...
        <Row className='gx-4 justify-content-between align-items-center form-row'>
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Learning Rate: <strong>{settings.learningRate.value}</strong></Form.Label>
                <Form.Range min={settings.learningRate.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Discount Factor: <strong>{settings.discountFactor.value}</strong></Form.Label>
                <Form.Range min={settings.discountFactor.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Horizontal: <strong>{settings.gridSpatialAbstraction.horizontal.value}</strong></Form.Label>
                <Form.Range min={settings.gridSpatialAbstraction.horizontal.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Vertical: <strong>{settings.gridSpatialAbstraction.vertical.value}</strong></Form.Label>
                <Form.Range min={settings.gridSpatialAbstraction.vertical.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Stay Alive: <strong>{settings.rewards.stayAlive.value}</strong></Form.Label>
                <Form.Range min={settings.rewards.stayAlive.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Passed Pipe: <strong>{settings.rewards.passedPipe.value}</strong></Form.Label>
                <Form.Range min={settings.rewards.passedPipe.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Hit Pipes: <strong>{settings.rewards.hitObstacle.value}</strong></Form.Label>
                <Form.Range min={settings.rewards.hitObstacle.min}
            ...
            <Col xs={12} md={6}>
                <Form.Label className='fs-3'>Hit Floor or Ceiling: <strong>{settings.rewards.hitFloorOrCeiling.value}</strong></Form.Label>
                <Form.Range min={settings.rewards.hitFloorOrCeiling.min}
