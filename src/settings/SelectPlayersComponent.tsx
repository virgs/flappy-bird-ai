...
export const SelectPlayersComponent = (props: SelectPlayersComponentProps) => {
    ...
    return <div id='select-players-component' className='d-flex h-100 w-100 flex-column align-items-between p-2'>
        ...
        <Accordion flush className='my-2'>
            {accordionSructure
                .map((item, index) => {
                    ...
                    return <Accordion.Item eventKey={index.toString()} key={item.label} style={{ backgroundColor: backgroundColor }}>
                        <Accordion.Header>
                            <FontAwesomeIcon className='fs-2 text-tertiary me-2' style={{ width: '10%' }} icon={item.icon} />
        ...
        <Button variant="outline-primary" className='play-button mt-auto w-100'
